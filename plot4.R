...
# plot Voltage line
plot(hpc2$Time2, hpc2$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")

# plot Reactive Power line
plot(hpc2$Time2, hpc2$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global Reactive Power")
